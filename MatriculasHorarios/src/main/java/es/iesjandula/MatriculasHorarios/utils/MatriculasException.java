package es.iesjandula.MatriculasHorarios.utils;
...
public class MatriculasException extends Exception
{
	 ...
	 */
	public MatriculasException(int code, String message) 
	{
		super(message);
	 ...
	 */
	public MatriculasException(int code, String message, Exception exception) 
	{
